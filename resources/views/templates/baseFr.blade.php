        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/home/fr">Ivan Armagnat</a>
                    </div>
                    <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="{{ $active == 'home' ? 'active' : '' }}"><a href="/home/fr"><i class="fa fa-home"></i></a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="{{ $active == 'presentation' ? 'active' : '' }}"><a href="/presentation/fr">Présentation</a></li>
                        <li class="{{ $active == 'resume' ? 'active' : '' }}"><a href="/resume/fr">CV</a></li>
                        <li class="{{ $active == 'contact' ? 'active' : '' }}"><a href="/contact/fr">Contact</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-7 col-sm-9 col-lg-10" id="footerMail">
                    <p id="footContactLarge">Contactez moi: <a href="mailto:ivan.armagnat@gmail.com">ivan.armagnat@gmail.com</a>.</p>
